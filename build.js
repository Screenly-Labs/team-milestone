...
// Opening Hours apps this is a plain static bundle — no server. The milestone
...
//   4. bundle TypeScript → browser JS (minified, ./milestone inlined)
...
const DIST = 'dist'
const DOMAIN = 'team-milestone.srly.io'
...
// 4. TypeScript → browser JS with esbuild. Bundles main.ts (inlining ./milestone
